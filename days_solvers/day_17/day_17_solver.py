    ...
    def find_cycle(self, jets_pattern, rocks):
        ...
        while True:
            ...
            while can_fall:
                ...
                i, j = self.check_if_cycle(register, len(rocks), len(jets_pattern))
                if i != -1 and j != -1:
                    return register[i], register[j]
                step += 1
            rocks_ctr += 1

    def check_if_cycle(self, register, rocks_len, jets_pattern_len):
        cyclotron = list(
